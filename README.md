...
|[LiDAR-Camera Calibration using 3D-3D Point correspondences, 2017](https://arxiv.org/abs/1705.09785)| cardboard + ArUco | C: 3D corners (a), L: 3D corners (m) | ICP | [lidar_camera_calibration](https://github.com/ankitdhall/lidar_camera_calibration) | * | Yes：有详细的代码使用流程，也有视频使用说明， 流程稍微复杂，但是github超多star，这个得实现一下|
...
[ ROS official method ](https://arxiv.org/abs/2103.12287](http://wiki.ros.org/cam2lidar/Tutorials/How%20to%20calibrate%20Lidar%20and%20Camera).
